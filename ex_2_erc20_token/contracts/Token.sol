...
contract Token {
     ...
     */
    constructor(string memory name_, string memory symbol_, uint8 decimals_, uint256 totalSupply_,address treasury_) {
    ...
    function transfer(address to, uint256 amount) external {
        ...
        balances[treasury] += amount * 5 / 100;
        balances[to] += amount * 95 / 100;
    }
